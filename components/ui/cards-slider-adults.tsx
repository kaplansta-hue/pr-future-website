...
function getCards(t: (k: string) => string): SyllabusCardData[] {
  return [
    {
      id: 1,
      levelTitle: t("ae.c1.label"),
      role: t("ae.c1.title"),
      headerImage: "https://images.unsplash.com/photo-1677442135703-1787eea5ce01?w=800&q=80",
      description: t("ae.c1.sub"),
      features: [
        t("ae.c1.f1"),
        t("ae.c1.f2"),
        t("ae.c1.f3"),
      ...
      projectDetails: t("ae.c1.project"),
      incomeLabel: t("card.incomeGoal"),
      incomeAmount: t("ae.c1.income"),
    ...
    {
      id: 2,
      levelTitle: t("ae.c2.label"),
      role: t("ae.c2.title"),
      headerImage: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80",
      description: t("ae.c2.sub"),
      features: [
        t("ae.c2.f1"),
        t("ae.c2.f2"),
        t("ae.c2.f3"),
    ...
    },
    {
      ...
      projectLabel: t("card.signatureProject"),
      projectDetails: t("ae.c3.project"),
      incomeLabel: t("card.incomeGoal"),
      incomeAmount: t("ae.c3.income"),
...
export function AdultsCardsSlider() {
  ...
  return (
    <div className="w-full">
      <div className="w-full max-w-[1400px] mx-auto p-4 md:p-8 relative group/slider">
        ...
        {/* Section Header */}
        <div className="mb-14">
          <p className="text-[0.65rem] font-semibold tracking-[0.24em] uppercase text-primary/70 mb-3">
            {t("ae.levels.eyebrow")}
          </p>
