  ...
  return (
    <>
      ...
      <section className="yf-hero">
        <div className="yf-eyebrow">{t("yf.eyebrow")}</div>
        <h1 className="yf-title">{t("yf.title.line1")}<br />{t("yf.title.line2")}</h1>
        <p className="yf-subtitle">{t("yf.subtitle")}</p>
      ...
      <section className="yf-vision" id="yf-vision">
        <p className="yf-mission">{t("yf.mission")}</p>
        <h2 className="yf-vision-title" style={{ whiteSpace: "pre-line" }}>{t("yf.vision.title")}</h2>
        <div className="pillars-list">
          {[
            { num: "01", title: t("yf.p01.title"), body: t("yf.p01.body") },
            { num: "02", title: t("yf.p02.title"), body: t("yf.p02.body") },
            { num: "03", title: t("yf.p03.title"), body: t("yf.p03.body") },
          ].map((p) => (
      ...
      <section className="journey-section" id="yf-journey">
        <div className="journey-header">
          <div className="journey-eyebrow">{t("yf.journey.eyebrow")}</div>
          <h2 className="journey-title">{t("yf.journey.title")}</h2>
        </div>
      ...
      <section className="objectives-section" id="yf-objectives">
        <div className="objectives-header">
          <div className="objectives-eyebrow">{t("yf.obj.eyebrow")}</div>
          <h2 className="objectives-title">{t("yf.obj.title")}</h2>
        </div>
      ...
      <section className="manifesto-section" id="yf-manifesto">
        <div className="manifesto-header">
          <h2 className="manifesto-title" style={{ whiteSpace: "pre-line" }}>{t("yf.manifesto.title")}</h2>
          <p className="manifesto-intro" style={{ whiteSpace: "pre-line" }}>{t("yf.manifesto.intro")}</p>
        </div>
      ...
      <section className="program-levels-section" id="yf-levels">
        <CardsSlider />
      </section>
